  ...
  return (
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-4">
            <h3 className="text-sm text-homestead-heading font-bold">
              Connect
            </h3>
            <ul className="flex gap-4">
              <li>
                <Link
                  ...
                  href="https://www.facebook.com/people/All-Ways-Home-IE/61578356010210/"
                  aria-label="Facebook"
                >
                  <svg
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-homestead-secondary transition hover:text-homestead-heading"
                  href="https://www.instagram.com/allwayshomeie/"
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-homestead-secondary transition hover:text-homestead-heading"
                  href="https://www.linkedin.com/company/all-ways-home-ie"
                  aria-label="LinkedIn"
                >
                  <svg
                    className="h-8 w-8 fill-current"
	...
	L341.91,330.654L341.91,330.654z"
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-homestead-secondary transition hover:text-homestead-heading"
                  href="https://bsky.app/profile/allwayshomeie.bsky.social"
                  aria-label="Bluesky"
                >
                  <svg
                    className="h-8 w-8 fill-current"
